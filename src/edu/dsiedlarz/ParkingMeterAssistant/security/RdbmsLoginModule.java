package edu.dsiedlarz.ParkingMeterAssistant.security;/* Java imports */
...
/**
 * <p>
 * edu.dsiedlarz.ParkingMeterAssistant.security.RdbmsLoginModule is a LoginModule that authenticates
...
public class RdbmsLoginModule implements LoginModule {
    ...
    public void initialize(Subject subject, CallbackHandler callbackHandler,
        ...
        if (debug) {
            System.out.println("\t\t[edu.dsiedlarz.ParkingMeterAssistant.security.RdbmsLoginModule] initialize");
            System.out.println("\t\t[edu.dsiedlarz.ParkingMeterAssistant.security.RdbmsLoginModule] url: " + url);
            System.out.println("\t\t[edu.dsiedlarz.ParkingMeterAssistant.security.RdbmsLoginModule] driver: " + driverClass);
        }
    }
    ...
    public boolean login() throws LoginException {
        ...
        if (debug)
            System.out.println("\t\t[edu.dsiedlarz.ParkingMeterAssistant.security.RdbmsLoginModule] login");
    ...
    public boolean commit() throws LoginException {
        ...
        if (debug)
            System.out.println("\t\t[edu.dsiedlarz.ParkingMeterAssistant.security.RdbmsLoginModule] commit");
        ...
        if (success) {
            ...
            try {
                ...
                if (debug) {
                    while (it.hasNext())
                        System.out.println("\t\t[edu.dsiedlarz.ParkingMeterAssistant.security.RdbmsLoginModule] Principal: " + it.next().toString());
                }
    ...
    public boolean abort() throws javax.security.auth.login.LoginException {
        ...
        if (debug)
            System.out.println("\t\t[edu.dsiedlarz.ParkingMeterAssistant.security.RdbmsLoginModule] abort");
    ...
    public boolean logout() throws javax.security.auth.login.LoginException {
        ...
        if (debug)
            System.out.println("\t\t[edu.dsiedlarz.ParkingMeterAssistant.security.RdbmsLoginModule] logout");
        ...
        while (it.hasNext()) {
            ...
            if(debug)
                System.out.println("\t\t[edu.dsiedlarz.ParkingMeterAssistant.security.RdbmsLoginModule] removing principal "+p.toString());
        ...
        while (it.hasNext()) {
            ...
            if(debug)
                System.out.println("\t\t[edu.dsiedlarz.ParkingMeterAssistant.security.RdbmsLoginModule] removing credential "+c.toString());
    ...
    private boolean rdbmsValidate(String user, String pass) throws Exception {
        ...
        try {
            if (debug)
                System.out.println("\t\t[edu.dsiedlarz.ParkingMeterAssistant.security.RdbmsLoginModule] Trying to connect...");

            con = DriverManager.getConnection(url, "Administrator", "");

            if (debug)
                System.out.println("\t\t[edu.dsiedlarz.ParkingMeterAssistant.security.RdbmsLoginModule] connected!");

            stmt = con.createStatement();

            if (debug)
                System.out.println("\t\t[edu.dsiedlarz.ParkingMeterAssistant.security.RdbmsLoginModule] "+query);
            ...
            if (debug)
                System.out.println("\t\t[edu.dsiedlarz.ParkingMeterAssistant.security.RdbmsLoginModule] '"+pass + "' equals '" + dbPassword + "'?");

            passwordMatch = pass.equals(dbPassword);
            if (passwordMatch) {
                if (debug)
                    System.out.println("\t\t[edu.dsiedlarz.ParkingMeterAssistant.security.RdbmsLoginModule] passwords match!");
                ...
                if (debug)
                    System.out.println("\t\t[edu.dsiedlarz.ParkingMeterAssistant.security.RdbmsLoginModule] passwords do NOT match!");
            }
            stmt.close();
            con.close();
        }
